...
issues=[]
patterns=[r'-----BEGIN (?:RSA |EC |OPENSSH )?PRIVATE KEY-----',r'gh[pousr]_[A-Za-z0-9]{30,}',r'github_pat_[A-Za-z0-9_]{30,}',r'AKIA[0-9A-Z]{16}',r'/Users/[A-Za-z0-9._-]+/',r'185\.185\.71\.196',r'10\.195\.\d+\.\d+',r'Чернетченко',r'Дом Радио',r'1835/2022']
for name in filter(None,files):
 ...
 if name=='scripts/audit-public.py':continue
 try:s=p.read_text()
 except UnicodeDecodeError:continue
 for pat in patterns:
  if re.search(pat,s):issues.append(name+': private marker '+pat)
if issues:
