#!/usr/bin/env python3
"""Audit tracked source files, including the audit code, before publication."""
...
private_terms=json.loads(os.environ.get('PUBLIC_DENY_TERMS') or '[]')
...
print(f'Public source audit passed: {len(files)-1} tracked files')
